...
class Game{
    ...
    int isCorrectNumber(){
        ...
        if (guessed_Number == number){
            ...
            System.out.format("Hurray!! you guessed right, it was %d.\nYour score is %d.\n\n", number, scores);
            return scores;
        }
        else if(guessed_Number<number){
            System.out.println("Guessed number is much low than actual number\n");
        }
        else if(guessed_Number>number){
            System.out.println("Guessed number is much high than actual number\n");
        }
        if(noOfGuesses == 10){
            return 11;
        }
...
public class guess_number {
    public static void main(String[] args) {
        ...
        for(int i=1;i<=no_of_rounds;i++){
            ...
            if(b==11){
                System.out.println("Game Over!! Better Luck Next time!! You have used all your attempts.");
            }
        }
